...
public sealed class TokenLimitService : ITokenLimitService
{
    ...
    [
        ...
        (new Regex("^kurisu-plus-latest$", RegexOptions.IgnoreCase | RegexOptions.Compiled), 1_000_000),
        (new Regex("^kurisu-flash-latest$", RegexOptions.IgnoreCase | RegexOptions.Compiled), 1_000_000),
        ...
        (new Regex("^kurisu", RegexOptions.IgnoreCase | RegexOptions.Compiled), 262_144),
    ...
    [
        ...
        (new Regex("^kurisu", RegexOptions.IgnoreCase | RegexOptions.Compiled), 32_768),
    ...
    public static string Normalize(string model)
    {
        ...
        if (!Regex.IsMatch(normalized, "^kurisu-(?:plus|flash|vl-max)-latest$") &&
