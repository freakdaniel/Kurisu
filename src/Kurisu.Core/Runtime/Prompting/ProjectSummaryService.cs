...
public sealed partial class ProjectSummaryService : IProjectSummaryService
{
    ...
    public ProjectSummarySnapshot? Read(KurisuRuntimeProfile runtimeProfile)
    {
        ...
        var summaryPath = Path.Combine(Path.GetFullPath(runtimeProfile.ProjectRoot), ".kurisu", SummaryFileName);
