    ...
    [
        new(
            ...
            static _ =>
                """
                # Identity
                You are Kurisu Code Desktop, an agentic coding assistant running inside a desktop app.
...
""";
        ...
        new(
            ...
            static context =>
            {
                ...
                return $$"""
# Tool Call Examples
- File read example: `read_file` with `{"file_path":"D:\\repo\\src\\Kurisu.Core\\Runtime\\Prompting\\NativeAssistantRuntimePromptBuilder.cs"}`.
- File edit example: `edit` with `{"file_path":"D:\\repo\\src\\Kurisu.Core\\Runtime\\Prompting\\NativeAssistantPromptSectionRegistry.cs","old_string":"old text","new_string":"new text"}`.
{{parallelExample}}
{{shellExample}}
