...
internal static class OpenAiCompatibleProtocol
{
    ...
    public static bool IsDashScopeEndpoint(string endpointOrBaseUrl)
    {
        ...
        return uri.Host.EndsWith("dashscope.aliyuncs.com", StringComparison.OrdinalIgnoreCase) ||
               ...
               uri.Host.EndsWith("portal.kurisu.ai", StringComparison.OrdinalIgnoreCase);
    }
    ...
    public static string BuildUserAgent()
    {
        ...
        return $"Kurisu/{version} ({platform}; {architecture})";
    }
    ...
    /// <summary>
    /// Normalizes payload for kurisu-compatible requests routed through Kurisu OAuth / DashScope endpoints.
    /// </summary>
    /// <param name="payload">The payload</param>
    /// <param name="streaming">The streaming</param>
        ...
        bool disableTools)
    {
        ...
        // The official Kurisu CLI only sends model/messages/tools for chat turns and
