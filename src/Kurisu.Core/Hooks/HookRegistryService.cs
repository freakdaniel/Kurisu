    ...
    IExtensionCatalogService? extensionCatalogService = null)
{
    ...
    public HookExecutionPlan BuildUserPromptSubmitPlan(KurisuRuntimeProfile runtimeProfile)
        => BuildPlan(
            runtimeProfile,
    ...
    /// <returns>The resulting hook execution plan</returns>
    public HookExecutionPlan BuildPlan(KurisuRuntimeProfile runtimeProfile, HookEventName eventName)
        => BuildPlan(
            runtimeProfile,
            new HookInvocationRequest
            {
    ...
    private static bool IsProjectSettings(string path, KurisuRuntimeProfile runtimeProfile) =>
