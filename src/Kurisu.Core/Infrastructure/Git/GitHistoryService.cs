...
public sealed class GitHistoryService(
    ...
    KurisuRuntimeProfileService runtimeProfileService) : IGitHistoryService
{
    ...
    private void EnsureInitialized(KurisuRuntimeProfile runtimeProfile)
    {
        var historyDirectory = runtimeProfile.HistoryDirectory;
        ...
        _ = gitCliService.Run(historyDirectory, "config", "user.name", "Kurisu Code");
        _ = gitCliService.Run(historyDirectory, "config", "user.email", "kurisu@kurisu.local");
    ...
    private GitCommandResult RunHistoryGit(KurisuRuntimeProfile runtimeProfile, params string[] arguments)
    {
