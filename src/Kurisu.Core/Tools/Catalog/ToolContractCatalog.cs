...
internal static class ToolContractCatalog
{
    ...
    [
        ...
        new(WellKnownToolNames.RunShellCommand, "Shell", "execute", true, "native://tools/run_shell_command"),
        new(WellKnownToolNames.WriteFile, "WriteFile", "modify", true, "native://tools/write_file"),
        new("edit", "Edit", "modify", true, "native://tools/edit"),
        new(WellKnownToolNames.TodoWrite, "TodoWrite", "modify", true, "native://tools/todo_write"),
        ...
        new(WellKnownToolNames.ExitPlanMode, "ExitPlanMode", "control", true, "native://tools/exit_plan_mode"),
        new(WellKnownToolNames.WebFetch, "WebFetch", "execute", true, "native://tools/web_fetch"),
        new(WellKnownToolNames.WebSearch, "WebSearch", "execute", true, "native://tools/web_search"),
        ...
        new(WellKnownToolNames.AskUserQuestion, "AskUserQuestion", "coordination", true, "native://tools/ask_user_question"),
