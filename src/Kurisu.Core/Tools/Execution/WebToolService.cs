    ...
    HttpClient? httpClient = null) : IWebToolService
{
    ...
    /// <inheritdoc />
    public bool IsSearchAvailable(KurisuRuntimeProfile runtimeProfile) =>
...
""";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return "Web search is disabled. Configure a webSearch provider in your kurisu-compatible settings.json.";
        }
