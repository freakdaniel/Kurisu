...
internal static class TaskStore
{
    ...
    public static string ResolveTaskFilePath(Kurisu.Core.Models.KurisuRuntimeProfile runtimeProfile, string? sessionId)
    {
    ...
    public static async Task<TaskCreateResult> CreateTaskAsync(
        Kurisu.Core.Models.KurisuRuntimeProfile runtimeProfile,
