...
{
    internal const string MemorySectionHeader = "## Kurisu Added Memories";
    ...
    public static string ResolveMemoryFilePath(KurisuRuntimeProfile runtimeProfile, string? scope)
    {
