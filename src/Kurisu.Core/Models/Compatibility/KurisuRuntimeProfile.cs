...
/// <summary>
/// Represents the Kurisu Runtime Profile
/// </summary>
public sealed class KurisuRuntimeProfile
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the global kurisu directory
    /// </summary>
    public required string GlobalKurisuDirectory { get; init; }
