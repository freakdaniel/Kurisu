...
namespace Kurisu.Core.Extensions;
...
{
    private const string ManifestFileName = "kurisu-extension.json";
    private const string InstallMetadataFileName = ".kurisu-extension-install.json";
    ...
    {
        var tempDirectory = Path.Combine(Path.GetTempPath(), $"kurisu-extension-git-{Guid.NewGuid():N}");
