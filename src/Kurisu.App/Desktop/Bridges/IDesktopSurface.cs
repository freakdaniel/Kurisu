...
public interface IDesktopSurface
{
    ...
    /// </summary>
    /// <param name="request">The request payload</param>
    /// <returns>A task that resolves to list provider models response</returns>
    Task<ListProviderModelsResponse> ListProviderModelsAsync(ListProviderModelsRequest request);
