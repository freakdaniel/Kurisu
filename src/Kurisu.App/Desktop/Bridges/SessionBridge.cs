...
/// </summary>
public sealed class SessionBridge : ISessionBridge, ISessionEventPublisher
{
    ...
    private readonly KurisuRuntimeProfileService _runtimeProfileService;
    private readonly IServiceProvider _services;
    private readonly ILocaleStateService _localeStateService;
    private EventHandler<DesktopSessionEvent>? _sessionEvent;

    /// <summary>
    /// Initializes a new instance of <see cref="SessionBridge"/>
    /// </summary>
    ...
    private static string ResolveWorkingDirectory(KurisuRuntimeProfile runtimeProfile, string requestedWorkingDirectory)
    {
