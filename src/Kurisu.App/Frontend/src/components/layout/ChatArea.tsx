...
export default function ChatArea({
  ...
  const handleSubmit = useCallback(async () => {
    ...
    void window.kurisuDesktop.startSessionTurn({
  ...
  const handleStopGeneration = useCallback(async () => {
    if (!selectedSessionId || !window.kurisuDesktop) {
      return;
    }

    try {
      await window.kurisuDesktop.cancelSessionTurn({ sessionId: selectedSessionId });
    } catch (error) {
