...
namespace Kurisu.Tests.Channels;
...
public sealed class ChannelRuntimeServiceTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-channel-pairing-{Guid.NewGuid():N}");
        ...
        try
        {
            ...
            var pairingPath = Path.Combine(homeRoot, ".kurisu", "channels", "ops-pairing.json");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-channel-routing-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-channel-service-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-channel-replay-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
        ...
        try
        {
            ...
            var outboxRoot = Path.Combine(homeRoot, ".kurisu", "channels", "outbox");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-channel-background-replay-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-channel-lifecycle-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
