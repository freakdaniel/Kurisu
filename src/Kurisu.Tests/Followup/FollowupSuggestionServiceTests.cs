...
public sealed class FollowupSuggestionServiceTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-followup-provider-{Guid.NewGuid():N}");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-followup-cache-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-followup-provider-filter-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-followup-approval-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-followup-review-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
