...
public sealed class ApprovalPolicyTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-approvals-{Guid.NewGuid():N}");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-shell-virtual-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-shell-compound-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-shell-safety-{Guid.NewGuid():N}");
        Directory.CreateDirectory(root);
