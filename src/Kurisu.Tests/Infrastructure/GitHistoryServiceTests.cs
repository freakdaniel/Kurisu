...
public sealed class GitHistoryServiceTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-history-empty-{Guid.NewGuid():N}");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-history-create-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-history-restore-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
