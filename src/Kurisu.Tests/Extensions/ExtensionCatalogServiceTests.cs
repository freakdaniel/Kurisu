...
namespace Kurisu.Tests.Extensions;
...
public sealed class ExtensionCatalogServiceTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-ext-{Guid.NewGuid():N}");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-ext-link-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-ext-toggle-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-ext-settings-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-ext-update-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
        ...
        try
        {
            ...
            File.WriteAllText(
                Path.Combine(sourcePath, "kurisu-extension.json"),
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-ext-scaffold-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
        ...
        try
        {
            ...
            Assert.True(File.Exists(Path.Combine(targetPath, "kurisu-extension.json")));
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), $"kurisu-ext-consent-{Guid.NewGuid():N}");
        var workspaceRoot = Path.Combine(root, "workspace");
        var homeRoot = Path.Combine(root, "home");
