...
internal sealed class TypeScriptEmitter
{
    ...
    public string Emit(IReadOnlyCollection<IpcMethod> methods)
    {
        ...
        sb.AppendLine("/* Auto-generated by Kurisu.IpcGen. */");
        ...
        sb.AppendLine("export interface KurisuDesktopBridge {");
        ...
        sb.AppendLine("export const kurisuDesktopChannels = {");
        foreach (var method in methods.OrderBy(item => item.Channel))
        {
    ...
    private static bool ShouldEmitStructuredType(Type type)
    {
        ...
        return ns.StartsWith("Kurisu.App", StringComparison.Ordinal) ||
               ns.StartsWith("Kurisu.Core.Models", StringComparison.Ordinal) ||
               ns.StartsWith("Kurisu.Core.Runtime", StringComparison.Ordinal);
    }
